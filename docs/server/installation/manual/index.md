...
Μετά τον ορισμό των διαμερίσεων ξεκινά η αντιγραφή των αρχείων των Windows
  στην κατάτμηση και ακολουθεί η εγκατάσταση χαρακτηριστικών και αναβαθμίσεων. Επιλέξτε ***Install*** για να ξεκινήσει η εγκατάσταση.
  Το σύστημα εγκατάστασης σας ενημερώνει για την πρόοδο της εγκατάστασης.
...
Τέλος ζητείται η συνέναισή σας για την αποστολή διαγνωστικών δεδομένων στη Microsoft.

- Επιλέξτε ***Required only*** και

- Επιλέξτε ***Accept***.

Η εγκατάσταση έχει πλέον ολοκληρωθεί επιτυχώς.

Πλέον μπορείτε να συνεχίσετε με το βήμα των [Βασικών ρυθμίσεων του λειτουργικού συστημάτος](../../basic-settings/index.md).
