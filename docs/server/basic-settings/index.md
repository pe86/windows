...
[![Ορισμός τοπικού δικτύου ως ιδιωτικού](17a-set-private-network.png)](17a-set-private-network.png)
[![Επιλογή ιδιωτικού δικτύου](17a-set-private-network2.png)](17a-set-private-network2.png)
...
!!! Warning "Προσοχή"
    Σε περίπτωση που ο εξυπηρετητής δεν ήταν συνδεμένος στο τοπικό δίκτυο όταν κάνατε εκκίνηση και δεν έχει εμφανιστεί το παραπάνω μήνυμα μπορείτε από τις ρυθμίσεις: ***Start μενού***  ▸  ***δεξί-click***  ▸  ***Settings***   ▸  ***Network & Internet***  ▸  ***Ethernet*** να ορίσετε το δίκτυό σας ως **Private Network**.
...
[![Set IP/DNS](19-set-IP-DNS.png)](19-set-IP-DNS.png)
...
[![Set computer name](20-set-computer-name.png)](20-set-computer-name.png)
...
## 02. Δημιουργία διαμερίσεων[![Διαμέριση χρηστών](21a-users-partition.png)](21a-users-partition.png)
[![Διαμέριση χρηστών](21b-users-partition.png)](21b-users-partition.png)
...
[![Ενεργοποίηση άδειας](22-registration.png)](22-registration.png)
...
## 05. Απενεργοποίηση του Enhanced Security του Internet Explorer[![Απενεργοποίηση Enhanced Security](26-disable-enhanced-security.jpg)](26-disable-enhanced-security.jpg)
...
[![Remote Desktop Users screenshot](03-remote-desktop-users.png)](03-remote-desktop-users.png)
...
[![Share folder Users screenshot](06-share-folder-users.png)](06-share-folder-users.png)

Όπως έχει ήδη αναφερθεί στην ενότητα [Προτεινόμενες Διαμερίσεις](../installation/partitioning.md), υπάρχει μία διαμέριση για την αποθήκευση των αρχείων των χρηστών και των κοινόχρηστων αρχείων.
...
- Επιλέξτε ***Permissions***
- Διαγράψτε, επιλέγοντας ***Remove***, το Group **Everyone**
- Προσθέστε, επιλέγοντας ***Add*** το Group **Authenticated Users** και δώστε του **Full Control**
...
!!! powershell "PowerShell: Διαμοιρασμός φακέλου Users"
    ...
    New-SmbShare -Name "Users" -Path "G:\users" -FullAccess "Authenicated Users"
    ```

### Διαμοιρασμός εκτυπωτή {#printer-sharing}

[![Printer sharing screenshot](09-printer-sharing.png)](09-printer-sharing.png)

Κατά την εγκατάσταση του εκτυπωτή το σύστημα σας ζητά να δηλώσετε εάν θέλετε να τον διαμοιράσει. Σε περίπτωση θετικής απάντησης ο εκτυπωτής διαμοιράζεται δικτυακά. Αν έχετε επιλέξει όχι, μπορείτε επιλέγοντας  ***Windows Start*** ▸ ***Settings*** ▸ ***Bluetooth & Devices*** ▸ ***<Όνομα Εκτυπωτή>***  να επιλέξετε τον εκτυπωτή που έχετε εγκαταστήσει (ή να προσθέσετε έναν καινούριο εκτυπωτή) και κατόπιν να επιλέξετε ***Printer Properties*** ▸ ***Καρτέλα Sharing***  να ενεργοποιήσετε το διαμοιρασμό του.

Οι χρήστες που έχουν λογαριασμό στον εξυπηρετητή αυτομάτως θα μπορούν να τυπώσουν στον διαμοιραζόμενο εκτυπωτή.

!!! info clear "Πληροφορία"
    Για εγκατάσταση εκτυπωτών δείτε στο [περιφερειακά](../peripherals.md#printers)
...
!!! tip "Συμβουλή"
    ...
    υπάρχουν διαμοιραζόμενοι φάκελοι που χρειάζονται προστασία / διατήρηση παλαιότερων εκδόσεων κτλ.

[![Shadow copies via Server Manager](10-shadow-copies-via-server-manager.png)](10-shadow-copies-via-server-manager.png)
{.clear}
...
[![Select disk for shadow copies](11-shadow-copies-select-disk.png)](11-shadow-copies-select-disk.png)  
{.clear}
...
[![Enable shadow copies](12-shadow-copies-enable.png)](12-shadow-copies-enable.png)
{.clear}

Επιλέγετε το tab **Shadow Copies** και κατόπιν το κουμπί ***Enable***.  

[![Shadow copies schedule](13-shadow-copies-schedule.png)](13-shadow-copies-schedule.png)
{.clear}

Με την επιλογή ενεργοποίησης εμφανίζεται προειδοποιητικό μήνυμα αποδοχής, το οποίο αποδέχεστε πατώντας το κουμπί ***Yes***.  

[![Shadow copies settings confirmation](14-shadow-copies-settings.png)](14-shadow-copies-settings.png)
{.clear}

Αποδεχθείτε τις προκαθορισμένες ρυθμίσεις πατώντας το ***Yes***, είτε τις αλλάζετε πατώντας το ***Settings***  

[![Shadow copies size settings](15-shadow-copies-size.png)](15-shadow-copies-size.png)
{.clear}
...
[![Shadow copies schedule](16-shadow-copies-schedule.png)](16-shadow-copies-schedule.png)
{.clear}
...
[![Print and Document Services role install](17-Print-and-Document-Services-role-install.png)](17-Print-and-Document-Services-role-install.png)

[![Print Server install](18-Print-Server-install.png)](18-Print-Server-install.png)
...
[![Print Server add printer](19-Print-Server-add-printer.png)](19-Print-Server-add-printer.png)
