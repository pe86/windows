...
!!! info "Πληροφορία"
    Μετά την εγκατάσταση του εκτυπωτή, δείτε πώς μπορείτε [να τον διαμοιράσετε](../basic-settings/index.md#printer-sharing) ή να τον προσθέσετε σε [Print Server στον εξυπηρετητή](../basic-settings/index.md#print-server)).
