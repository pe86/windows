...
Μετά το πέρας της **βασικής εγκατάστασης** του [σταθμού εργασίας](../../10/index.md) και του [εξυπηρετητή του Σ.Ε.Π.Ε.Η.Υ.](../../2019/index.md), είναι δυνατή η δημιουργία του
...
!!! warning "Προσοχή"
    ...
    ορίσαμε [σε προηγούμενο βήμα](../../2019/installation/index.md#server-ip-dns-settings) αφαιρώντας τους DNS Servers του Π.Σ.Δ. Ο λόγος
