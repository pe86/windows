...
!!! info "Πληροφορία"
    Οι TCP/IP ρυθμίσεις μπορούν να πραγματοποιηθούν σύμφωνα με τις οδηγίες που έχουν εκδοθεί για τη διασύνδεση σχολικών εργαστηρίων στο ΠΣΔ.
...
### Απενεργοποίηση του Enhanced Security του Internet Explorer[![](26-disable-enhanced-security.jpg)](26-disable-enhanced-security.jpg)
