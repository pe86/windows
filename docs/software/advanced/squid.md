...
!!! info "Πληροφορία"
    Η εγκατάσταση του 'Squid' προτείνεται στον εξυπηρετητή του εργαστηρίου, εκτός και αν δεν υπάρχει, οπότε μπορεί να πραγμαποιηθεί σε έναν σταθμό εργασίας.
...
[![Squid manual proxy setup screenshot](Squid_Manual_Proxy_Setup.png)](Squid_Manual_Proxy_Setup.png)
{.clear}
...
* Πατήστε **`Windows Key`** ▸ ***γρανάζι Ρυθμίσεις (Settings)*** ▸ ***Δίκτυο και Internet (Network and Internet)*** ▸ ***Διακομιστής μεσολάβησης (Proxy)***
* Στο **Μη αυτόματη ρύθμιση διακομιστή μεσολάβησης** πατήστε το κουμπί ***Ρύθμιση*** και ενεργοποιήστε (Ενεργό) ***Χρήση διακομιστή μεσολάβησης (Use a proxy server)***
* Δηλώστε την IP του εξυπηρετητή σαν Διεύθυνση IP διακομιστή (Proxy IP address) και τη Θύρα (Port) που "ακούει" στο squid (3128)
* Πατήστε το ***Αποθήκευση (Save)***.
