...
Για τους "αρχάριους" προτείνεται η εγκατάσταση επιπλέον λογισμικού σε περιβάλλον Windows για τις ακόλουθες κατηγορίες εφαρμογών:
...
Οι "προχωρημένοι" μπορούν να ακολουθήσουν τις οδηγίες για την εγκατάσταση [πιο σύνθετων εφαμογών](advanced/index.md)

## Windows Package Manager (winget) {#winget}

Η εγκατάσταση των λογισμικών μπορεί να γίνει είτε χειροκίνητα ακολουθώντας τις οδηγίες εγκατάστασης κάθε λογισμικού, είτε με το [`winget`](https://learn.microsoft.com/en-us/windows/package-manager/winget/). Πρόκειται για έναν Windows Package Manager που δίνεται ως ΕΛ/ΛΑΚ εφαρμογή από τον οίκο Microsoft και αποτελείται από μία εφαρμογή που από γραμμή εντολών, διευκολύνει την εγκατάσταση εφαρμογών μέσα από ένα κανάλι διανομής (όπως το apt στο Ubuntu που εγκαθιστά εφαρμογές από αποθετήρια που έχουν δηλωθεί ως έμπιστα). Δείτε τις διαθέσιμες εφαρμογές ή πακέτα εφαρμογών που μπορείτε να εγκαταστήσετε στο <https://winstall.app/>.

!!!info "Πληροφορία"
    Για να εγκαταστήσετε την εφαρμογή `Notepad++` που δίνεται ως πακέτο Notepad++.Notepad++ σε γραμμή εντολών, με δικαιώματα διαχειριστή, δώστε την ακόλουθη εντολή:
    ```shell
