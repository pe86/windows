...
Επιλέγετε ***Εγκατάσταση των Windows 11*** στη συνέχεια ***Συμφων΄ώ να διαγραφούν όλα, συμπεριλαμβανομένων των αρχείων, των εφαρμογών και των ρυθμίσεων*** και κατόπιν **Επόμενο**.

[![Setup windows key](02b-setup-windows-key.png)](02b-setup-windows-key.png)

Εάν διαθέτετε το κλειδί των Windows πληκτρολογήστε το, αλλιώς επιλέξτε ***Δεν διαθέτω αριθμό-κλειδί προϊόντος*** και στη συνέχεια επιλέξτε ***Επόμενο***

[![Setup windows edition iso](02c-setup-windows-iso.png)](02c-setup-windows-iso.png)

Στην ερώτηση για Επιλογή ειδώλου, επιλέξτε ***Windows 11 Pro*** και στη συνέχεια επιλέξτε ***Επόμενο***
...
Το επόμενο βήμα είναι η ανακεφαλαίωση των παραπάνω επιλογών. Επιλέξτε ***Εγκατάσταση***.
...
Στo παράθυρο **Ας ορίσουμε τις ρυθμίσεις για την εργασία ή το σχολείο**:
