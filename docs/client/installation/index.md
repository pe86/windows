...
!!! tip "Συμβουλή"
    ...
    - Σε περίπτωση που ο σταθμός εργασίας δεν ικανοποιεί τις [ελάχιστες απαιτήσεις](../requirements.md) για την εγκατάσταση των Windows 11, δοκιμάστε τη δημιουργία USB μέσου εγκατάστασης με αξιοποίηση του εργαλείου [`Rufus`](rufus.md)
